                ...
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            ...
                            <span class="lot__cost"><?=$val['productCost']; ?><b class="rub">р</b></span>
                        </div>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            <?php $simpleCategories = ["Доски и лыжи", "Крепления", "Ботинки", "Одежда", "Инструменты", "Разное"]; ?>

            <?php $index = 0;
            $num = count($simpleCategories);
            while ($index < $num) {
                $cat = $simpleCategories[$index];
                print('<li class="nav__item"> <a href="all-lots.html">' . $cat . '</a>');
                $index = $index + 1;
            }
            ?>
    </nav>
