...
<main class="container">
    ...
    <section class="lots">
        ...
        <!-- Задание 2.2
         Добавьте в код файла index.php двумерный массив, каждый элемент которого будет ассоциативным массивом с данными одного объявления. Информацию для этих массивов взять из таблицы. -->

        <?php
        $advertising = [
            0 => [
                'productURLimg' => 'img/lot-1.jpg',
        ...
        <!-- Задание 2.4
         Объявления выводятся как элементы списка ul.lots__list. Используя цикл для прохода по массиву с лотами, заполните этот список объявлениями. Каждый элемент списка (объявление) должно подставлять информацию в теги из соответствующего ключа массива. -->


        <li class="lots__item lot">
            <?php foreach ($advertising as $key => $value): ?>
            <div class="lot__image">
                <img src="<?= $value['productURLimg'] ?>" width="350" height="260" alt="Сноуборд">
            </div>
            <div class="lot__info">
                <span class="lot__category"><?= $value['productCategory'] ?></span>
                <h3 class="lot__title"><a class="text-link" href="lot.html"><?= $value['productName']; ?></a></h3>
                <div class="lot__state">
                    <div class="lot__rate">
                        <span class="lot__amount">Стартовая цена</span>
                        <span class="lot__cost"><?= $value['productPrice'] ?><b class="rub">р</b></span>
...
<footer class="main-footer">
    <nav class="nav">
        ...
        <?php $SimpleArrayCategories = ["Доски и лыжи", "Крепления", "Ботинки", "Одежда", "Инструменты", "Разное"];
        $categoryCount = 5;
        ?>
        <!-- Задание 2.3
        Найдите в HTML-коде список ul.nav__list. Используйте цикл, чтобы заменить содержимое списка данными из массива категорий./li> -->
        <ul class="nav__list container">
            <?php $index = 0; //индекс нулю равен
            $num = count($SimpleArrayCategories);// Считает сколько элементов в массиве - 6
            while ($index < $num) { //сравнивает переменные, если $index < 6 идет дальше, если нет завершает цикл
                $cat = $SimpleArrayCategories[$index]; //в переменную $cat попадает элемен массива $SimpleArrayCategories с номером из переменной index
                print('<li class="nav__item"> <a href="all-lots.html">' . $cat . '</a>'); //печатает строку с тегами контаминацией $cat и закрывающим тегом
                $index = $index + 1;
            } // к $index добавляется 1 и переход в начало цикла
            ?>
            </li>
        </ul>
